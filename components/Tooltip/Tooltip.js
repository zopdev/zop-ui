      ...
      {showTooltip &&
        ...
        createPortal(
          <div
            ref={tooltipRef}
            style={tooltipStyle}
            className="bg-gray-300 text-xs text-gray-600 px-4 py-2 rounded-md transition-opacity duration-300 text-wrap max-w-80"
          >
            {title}
            {arrow && (
              <div
                className="absolute w-2 h-2 bg-gray-300"
                style={{
