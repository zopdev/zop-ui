        ...
        {options.map((option, index) => {
          ...
          return (
            ...
            >
              ...
              <label
                htmlFor={inputId}
                className="text-sm flex gap-4 cursor-pointer font-medium text-gray-600 w-full p-2 px-4 border rounded-md peer-checked:bg-primary-200/10 peer-checked:text-primary-500 peer-checked:border-primary-400"
                style={{
