...
const headers = [
  ...
  // { key: 'namespace', label: 'Namespace', align: 'left', colClassName: '!sm:w-1/4' },
  { key: 'pods', label: 'Pods', align: 'left', colClassName: 'sm:w-1/4' },
  { key: 'replica', label: 'Replicas', align: 'left', colClassName: 'sm:w-1/4' },
  { key: 'age', label: 'Age', align: 'left', colClassName: 'sm:w-1/4' },
  { key: 'condition', label: 'Conditions', align: 'left', colClassName: 'sm:w-1/4' },
];
